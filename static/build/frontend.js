...
/******/ 	var hotCurrentHash = "cfb32469f4017702bfa6"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var client = _interopRequireWildcard(__webpack_require__(59));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function draw(data) {
	  ...
	  var lastPoint = data.lastPoint;
	
	  if (data.lastPoint) {
	    var len = vec2.length(vec2.sub(point, lastPoint));
	    var width = Math.pow(0.9, len) * 30;
	...
	/* HOT PATCH LOADER */ var __moduleBindings = ["register","init","draw","__eval"]; if(true) {
	  module.hot.accept(function(err) {
	    console.log('[HMR] Error accepting: ' + err);
	  });
